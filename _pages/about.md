...
# 🔥 News
- *07/2025*: &nbsp;🎉🎉 **[“领航计划”新闻报道]**(https://share.eyesnews.cn/news/news-news_detail-news_id-11515117012336.html).
...
- **Enhancing Biomedical Optical Volumetric Imaging via Self-Supervised Orthogonal Learning.** **Yuanjie Gu#**, Yiqun Wang#, Ang Xuan, Jianping Wang,  Linyi Wang, Lei Zhang, Xiaoran Li, Yao Wu, Jun Zhang, Zhi Lu* & Biqin Dong* (2025). **Revision.**  [![](https://img.shields.io/github/stars/FDU-donglab/VALID?style=social&label=Code+Stars)](https://github.com/FDU-donglab/VALID) [**Preprint**](https://www.biorxiv.org/content/10.1101/2025.05.16.654259v1)
- **Real-time self-supervised denoising for high-speed fluorescence neural imaging.** Yiqun Wang#, **Yuanjie Gu#**, Jianping Wang, Ang Xuan, Cihang Kong, Wei-Qun Fang, Dongyu Li, Dan Zhu, Fengfei Ding* & Biqin Dong* (2025). **Revision.**  [![](https://img.shields.io/github/stars/FDU-donglab/FAST?style=social&label=Code+Stars)](https://github.com/FDU-donglab/FAST) [**Preprint**](https://www.researchsquare.com/article/rs-6101322/v1)
- **AIGL: Adaptive Imbalance-to-Generalization Learning for Robust Multi-Label Retinal Disease Classification.** Jiacheng Yang,  **Yuanjie Gu**, and Zekuan Yu* (2025). **2025 IEEE International Conference on Systems, Man, and Cybernetics (SMC). Accepted**.
- **Automated Diagnosis of Non-Melanoma Skin Cancer: A Joint Learning Approach Using Optical Attenuation Coefficients.** Lei Zhang, Xiaoran Li, Wen Chen, **Yuanjie Gu**, Hao Wu*, Zhong Lu*, and Biqin Dong* (2025). **npj Digital Medicine, 8, 232. IF = 15.2**
...
- ```IEEE T-IM```**Automated Enhanced Handheld Fundus Photography via Unpaired Learning.** **Yuanjie Gu**, Jiacheng Yang, Yiqun Wang, Mengwen Ye, Xin Li, Xiaoran Li, Na Li, Jun Zhang, Yitian Zhao, Zekuan Yu* & Biqin Dong* (2025). **IEEE Transactions on Instrumentation & Measurement, 74(5005212), 1-12. IF = 5.6** 
...
- ```IEEE J-BHI```**SegCoFusion: An Integrative Multimodal Volumetric Segmentation Cooperating with Fusion Pipeline to Enhance Lesion Awareness.** **Yuanjie Gu**#, Yinghan Guan#, Zekuan Yu & Biqin Dong* (2023). **IEEE Journal of Biomedical and Health Informatics, 27(12), 5860-5871. IF = 7.1** 
...
- *07/2025*, Reviewer of [**IEEE Transactions on Instrumentation & Measurement**](https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=19).
- *05/2025*, Reviewer of [**IEEE SMC 2025**](https://www.ieeesmc.org/events/the-2025-ieee-international-conference-on-systems-man-and-cybernetics-smc-vienna-austria/).
- *04/2025*, Reviewer of [**Artificial Intelligence in Medicine**](https://www.sciencedirect.com/journal/artificial-intelligence-in-medicine).
- *11/2024*, Reviewer of [**Biomedical Signal Processing and Control**](https://www.sciencedirect.com/journal/biomedical-signal-processing-and-control).
- *11/2023*, Reviewer of [**IEEE Signal Processing Letters**](https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=97).
